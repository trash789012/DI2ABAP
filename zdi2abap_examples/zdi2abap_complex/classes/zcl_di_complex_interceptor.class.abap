"@Interceptor
CLASS zcl_di_complex_interceptor DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_DI_COMPLEX_INTERCEPTOR IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_DI_COMPLEX_INTERCEPTOR->ZIF_DI_PROXY_INTERCEPTOR~CALL_AFTER
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_DI_COMPLEX_INTERCEPTOR->ZIF_DI_PROXY_INTERCEPTOR~CALL_BEFORE
* +-------------------------------------------------------------------------------------------------+
* | [--->] IV_CLASS                       TYPE        STRING
* | [--->] IV_METHOD                      TYPE        STRING
* | [--->] IO_OBJECT                      TYPE REF TO OBJECT
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_DI_COMPLEX_INTERCEPTOR->ZIF_DI_PROXY_INTERCEPTOR~CALL_IN_EXCEPTION
* +-------------------------------------------------------------------------------------------------+
* | [--->] IV_CLASS                       TYPE        STRING
* | [--->] IV_METHOD                      TYPE        STRING
* | [--->] IO_OBJECT                      TYPE REF TO OBJECT
