...
DI2ABAP - это легковесный фрэймворк внедрения зависимостей на основе аннотаций (поддерживается и императивный подход), который провносит все современные паттерны разработки в экосистему SAP. 
...
5. Смотрите примеры с пакете ZDI2ABAP_EXAMPLES

## Зависимости
- Требуется SAP_BASIS 750+
